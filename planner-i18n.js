...
(function () {
  ...
  var D = {
    ...
    // projects — project folders hero + storyboard workspace
    'Project Folders': ['项目文件夹', 'プロジェクトフォルダ'],
    'Registry of your productions on disk': ['你磁盘上作品的登记簿', 'ディスク上の作品レジストリ'],
    'Scanning for project folders…': ['正在扫描项目文件夹…', 'プロジェクトフォルダをスキャン中…'],
    '+ New Project': ['+ 新建项目', '+ 新規プロジェクト'],
    'New Project': ['新建项目', '新規プロジェクト'],
    'No project folders yet — create your first': ['还没有项目文件夹——来创建第一个吧', 'プロジェクトフォルダはまだありません — 最初のひとつを作成しましょう'],
    'Designated folder': ['指定文件夹', '指定フォルダ'],
    'Open Folder': ['打开文件夹', 'フォルダを開く'],
    'Rename': ['重命名', '名前を変更'],
    'Change Folder': ['更改文件夹', 'フォルダを変更'],
    'Storyboard Workspace': ['分镜工作区', '絵コンテワークスペース'],
    'Creating…': ['创建中…', '作成中…'],
    'Create': ['创建', '作成'],
    'Cancel': ['取消', 'キャンセル'],
    // board
    ...
    '+ Insert': ['+ 插入', '+ 挿入'],
    // command palette + shortcuts + animatic
    '⌕ Quick search': ['⌕ 快速搜索', '⌕ クイック検索'],
    'Search shots, scenes, pages, actions…': ['搜索镜头、场景、页面、操作…', 'カット・シーン・ページ・操作を検索…'],
    'No matches': ['没有匹配项', '一致なし'],
    'Actions': ['操作', '操作'],
    'Navigate': ['跳转', '移動'],
    'Styles': ['风格', 'スタイル'],
    'New Shot': ['新建镜头', '新規カット'],
    'add a scene to the board': ['在看板新建一个场景', 'ボードにシーンを追加'],
    'add a shot to the selected scene': ['在选中场景添加镜头', '選択中のシーンにカットを追加'],
    'set active + open': ['设为当前并打开', 'アクティブにして開く'],
    'active': ['当前', '使用中'],
    'Scene Setup · Scene Board': ['场景搭建 · 场景看板', 'シーン設定 · シーンボード'],
    'Scene Setup · Characters': ['场景搭建 · 角色', 'シーン設定 · キャラクター'],
    'Scene Setup · Environments': ['场景搭建 · 环境', 'シーン設定 · 環境'],
    'Scene Setup · Timeline': ['场景搭建 · 时间线', 'シーン設定 · タイムライン'],
    '↑↓ navigate': ['↑↓ 选择', '↑↓ 選択'],
    '↵ open': ['↵ 打开', '↵ 開く'],
    'Keyboard shortcuts': ['键盘快捷键', 'キーボードショートカット'],
    'Quick search — shots, scenes, pages, actions': ['快速搜索——镜头、场景、页面、操作', 'クイック検索 — カット・シーン・ページ・操作'],
    'Next shot in the selected scene': ['选中场景内的下一个镜头', '選択中シーンの次のカット'],
    'Previous shot in the selected scene': ['选中场景内的上一个镜头', '選択中シーンの前のカット'],
    'New shot in the selected scene': ['在选中场景新建镜头', '選択中シーンに新規カット'],
    'Show this cheat sheet': ['显示本快捷键表', 'このチートシートを表示'],
    'Close any overlay': ['关闭任意浮层', 'オーバーレイを閉じる'],
    '▶ Play Animatic': ['▶ 播放动态分镜', '▶ アニマティック再生'],
    'Play the storyboard as an animatic — each shot held for its duration': ['把分镜作为动态样片播放——每个镜头按其时长停留', '絵コンテをアニマティックとして再生 — 各カットを尺どおり表示'],
    'Animatic Preview': ['动态分镜预览', 'アニマティックプレビュー'],
    '✕ Close': ['✕ 关闭', '✕ 閉じる'],
    'Previous shot (←)': ['上一个镜头 (←)', '前のカット (←)'],
    'Next shot (→)': ['下一个镜头 (→)', '次のカット (→)'],
    'Play / pause (Space)': ['播放/暂停 (空格)', '再生/一時停止 (スペース)'],
    'no thumbnail yet': ['暂无缩略图', 'サムネイル未設定'],
    ...
    'Delete profile': ['删除风格档案', 'プロファイルを削除'],
    'Convert to JSON': ['转换为 JSON', 'JSONへ変換'],
    'Saving…': ['保存中…', '保存中…'],
    'Saved ✓': ['已保存 ✓', '保存済み ✓'],
    'Downloaded ✓': ['已下载 ✓', 'ダウンロード済み ✓'],
    'JSON versions': ['JSON 版本', 'JSONバージョン'],
    'No saved JSON yet': ['还没有保存的 JSON', '保存済みJSONはまだありません'],
    'Project data': ['项目数据', '企画データ'],
    'Export full project JSON': ['导出完整项目 JSON', '企画全体をJSONで書き出し'],
    'Copy fragment': ['复制片段', '断片をコピー'],
    'Copied ✓': ['已复制 ✓', 'コピー済み ✓'],
    ...
    'No shots in this scene yet.': ['这个场景还没有镜头。', 'このシーンにはまだカットがありません。'],
    'Untitled shot': ['未命名镜头', '無題のカット'],
    ...
    // home hero + shell alerts
    'Compose entire films from a single luminous prompt.': ['用一条闪耀的提示词，谱写整部影片。', 'ひとつの輝くプロンプトから、映画をまるごと紡ぎ出す。'],
    'Enter the studio': ['进入工作室', 'スタジオへ入る'],
    'Storage is full — changes are no longer being saved. Export your project from the Style DNA page, then remove large reference images.':
      ['存储空间已满——更改已无法保存。请先在风格 DNA 页面导出项目，再删除较大的参考图。', 'ストレージが満杯です — 変更が保存されなくなりました。スタイルDNAページから企画を書き出し、大きな参考画像を削除してください。'],
  };
